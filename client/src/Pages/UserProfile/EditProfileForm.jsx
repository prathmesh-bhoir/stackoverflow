  ...
  return (
    <div>
        ...
        <form className="edit-profile-form" onSubmit={handleSubmit}>
            ...
            <label htmlFor="about">
                <h3>About me</h3>
                <textarea id="about" cols="30" rows="8" onChange={(e) => setAbout(e.target.value)} ></textarea>
            </label>
            <label htmlFor="tags">
                <h3>Watched tags</h3>
            ...
            <button type='button' className='user-cancel-btn' onClick={() => setSwitch(!setSwitch)}>Cancel</button>
        </form>
    </div>
  )
}
