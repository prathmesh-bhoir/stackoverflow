            ...
            <>
                {
                    questionsList.data.filter(question => question._id === id).map(question => (
                        <div key={question._id}>
                                    ...
                                    <div style={{width: "100%"}} >
                                        ...
                                        <div className="question-action-user">
                                            ...
                                            <div>
                                                ...
                                                <Avatar backgroundColor='orange' px='8px' py='5px' borderRadius='2px'>{question.userPosted.charAt(0).toUpperCase()}</Avatar>
                                                <div>
                                                    {question.userPosted.charAt(0).toUpperCase() + question.userPosted.slice(1)}
                                                </div>
                                                </Link>
                                            </div>
                                        </div>
                            ...
                            <section className="display-ans-container">
